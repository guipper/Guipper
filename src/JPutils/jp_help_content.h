...
namespace jp_help
{
	...
	inline const std::vector<Line> &table()
	{
		...
		E("Slider + modifiers", "Drag normally for size; Shift for opacity, Alt for hardness, Ctrl/Cmd for stabilizer. Stylus/touch pressure controls point width when the backend provides it",
			"Arrastra normal para tamano; Shift para opacidad, Alt para dureza y Ctrl/Cmd para estabilizador. La presion de lapiz/touch controla el ancho cuando el sistema la informa",
			Scope::Paint),
