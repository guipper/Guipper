...
float raymarch2(in vec3 from, in vec3 dir, in vec2 fragCoor) 
{
	vec2 uv = fragCoor.xy / iResolution.xy*2.-1.;
...
void main()
{
	...
	rota=mat2(cos(t),sin(t),-sin(t),cos(t));
	dir.xy=dir.xy*rota;
	float col=raymarch2(from,dir,fragCoord); 
