...
uniform float speed ;
#define TIME (-iTime * 0.4*speed)

#define LINE_LENGTH 1.0
#define LINE_SPACE 1.0
#define LINE_WIDTH 0.007
#define BOUNDING_CYLINDER 0.8
#define INSIDE_CYLINDER 0.32
#define EPS 0.0001
#define FOG_DISTANCE 30.0

#define FIRST_COLOR  vec3(116.0/255.0, 241.0/255.0, 163.0/255.0) *1.5
#define SECOND_COLOR vec3(19.0/255.0, 0.0, 216.0/255.0)
...
vec3 castPlanePoint(vec2 _fragCoord)
{
 	vec2 uv = (2.0 * _fragCoord - iResolution.xy) / iResolution.x;
